...
/* harmony import */ var _mock_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./mock/users.service */ "./src/app/@core/mock/users.service.ts");
/* harmony import */ var _mock_mock_data_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./mock/mock-data.module */ "./src/app/@core/mock/mock-data.module.ts");
...
var DATA_SERVICES = [
    { provide: _data_users__WEBPACK_IMPORTED_MODULE_7__["UserData"], useClass: _mock_users_service__WEBPACK_IMPORTED_MODULE_8__["UserService"] },
];
...
var SeoService = /** @class */ (function () {
    ...
    SeoService.prototype.trackCanonicalChanges = function () {
        ...
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(this.destroy$))
            .subscribe(function () {
...
var WebApi;
(function (WebApi) {
    var TWQXOrganizationApi = /** @class */ (function () {
        function TWQXOrganizationApi() {
        }
        TWQXOrganizationApi.connectTest = function (orgId, typ) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/connectTest?orgId=" + orgId + "&typ=" + typ;
        };
        TWQXOrganizationApi.getTOeUsersNotInOrganization = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/getTOeUsersNotInOrganization?orgId=" + orgId;
        };
        TWQXOrganizationApi.getTOeUsersInOrganization = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/getTOeUsersInOrganization?orgId=" + orgId;
        };
        TWQXOrganizationApi.getTWqxRefData = function (table, actInd, usedInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/getTWqxRefData?table=" + table + "&actInd=" + actInd + "&usedInd=" + usedInd;
        };
        TWQXOrganizationApi.approveRejectTWqxUserOrgs = function (orgID, userIDX, ApproveRejectCode) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/ApproveRejectTWqxUserOrgs?orgID=" + orgID + "&userIDX=" + userIDX + "&ApproveRejectCode=" + ApproveRejectCode;
        };
        TWQXOrganizationApi.getUserOrgsByUserIDX = function (userIDX, excludePendingInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/getUserOrgsByUserIDX?userIDX=" + userIDX + "&excludePendingInd=" + excludePendingInd;
        };
        TWQXOrganizationApi.getVWQXAllOrgs = function () { return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/getVWQXAllOrgs"; };
        TWQXOrganizationApi.GetWQXOrganizationById = function (orgID) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/GetWQXOrganizationById?OrgID=" + orgID;
        };
        TWQXOrganizationApi.getTEPAOrgByOrgId = function (orgID) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/GetT_EPA_ORGS_ByOrgID?OrgID=" + orgID;
        };
        TWQXOrganizationApi.InsertOrUpdateTWQXOrganization = function (oRG_ID, oRG_NAME, oRG_DESC, tRIBAL_CODE, eLECTRONIC_ADDRESS, eLECTRONICADDRESSTYPE, tELEPHONE_NUM, tELEPHONE_NUM_TYPE, TELEPHONE_EXT, cDX_SUBMITTER_ID, cDX_SUBMITTER_PWD, cDX_SUBMIT_IND, dEFAULT_TIMEZONE, cREATE_USER, mAIL_ADDRESS, mAIL_ADD_CITY, mAIL_ADD_STATE, mAIL_ADD_ZIP) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/InsertOrUpdateTWQXOrganization?oRG_ID=" + oRG_ID + "&oRG_NAME=" + oRG_NAME + "&oRG_DESC=" + oRG_DESC + "&tRIBAL_CODE=" + tRIBAL_CODE + "&eLECTRONIC_ADDRESS=" + eLECTRONIC_ADDRESS + "&eLECTRONICADDRESSTYPE=" + eLECTRONICADDRESSTYPE + "&tELEPHONE_NUM=" + tELEPHONE_NUM + "&tELEPHONE_NUM_TYPE=" + tELEPHONE_NUM_TYPE + "&TELEPHONE_EXT=" + TELEPHONE_EXT + "&cDX_SUBMITTER_ID=" + cDX_SUBMITTER_ID + "&cDX_SUBMITTER_PWD=" + cDX_SUBMITTER_PWD + "&cDX_SUBMIT_IND=" + cDX_SUBMIT_IND + "&dEFAULT_TIMEZONE=" + dEFAULT_TIMEZONE + "&cREATE_USER=" + cREATE_USER + "&mAIL_ADDRESS=" + mAIL_ADDRESS + "&mAIL_ADD_CITY=" + mAIL_ADD_CITY + "&mAIL_ADD_STATE=" + mAIL_ADD_STATE + "&mAIL_ADD_ZIP=" + mAIL_ADD_ZIP;
        };
        TWQXOrganizationApi.GetWQXUserOrgsAdminsByOrg = function (orgID) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/GetWQXUserOrgsAdminsByOrg?OrgID=" + orgID;
        };
        TWQXOrganizationApi.insertTWQXUserOrgs = function (orgID, userIDX, roleCD, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/InsertTWQXUserOrgs?oRG_ID=" + orgID + "&uSER_IDX=" + userIDX + "&rOLE_CD=" + roleCD + "&cREATE_USER=" + createUser;
        };
        TWQXOrganizationApi.deleteTWqxUserOrgs = function (orgID, userIDX) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/deleteTWqxUserOrgs?orgId=" + orgID + "&userIdx=" + userIDX;
        };
        TWQXOrganizationApi.getAdminTaskData = function (userName, OrgID) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/GetAdminTaskData?userName=" + userName + "&OrgID=" + OrgID;
        };
        TWQXOrganizationApi.GetWqxImportTranslatebyOrg = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/GetWqxImportTranslatebyOrg?orgId=" + orgId;
        };
        TWQXOrganizationApi.canUserEditOrg = function (userIdx, orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/org/canUserEditOrg?UserIDX=" + userIdx + "&OrgID=" + orgId;
        };
        return TWQXOrganizationApi;
    }());
    WebApi.TWQXOrganizationApi = TWQXOrganizationApi;
    var TWQXMonlocApi = /** @class */ (function () {
        function TWQXMonlocApi() {
        }
        TWQXMonlocApi.getWQXMonLoc = function (actInd, orgId, wqxPending) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/monloc/getWQXMonLoc?ActInd=" + actInd + "&OrgID=" + orgId + "&WQXPending=" + wqxPending;
        };
        TWQXMonlocApi.GetWQXMonLocByID = function (monlocIdx) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/monloc/GetWQXMonLocByID?MonLocIDX=" + monlocIdx;
        };
        TWQXMonlocApi.getWqxMonlocByOrgId = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/monloc/getWqxMonlocByOrgId?OrgID=" + orgId;
        };
        return TWQXMonlocApi;
    }());
    WebApi.TWQXMonlocApi = TWQXMonlocApi;
    var TWQXProjectApi = /** @class */ (function () {
        function TWQXProjectApi() {
        }
        TWQXProjectApi.getAllProjects = function () {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/project/getAllProjects";
        };
        TWQXProjectApi.getWQXProjectMyOrgCount = function (userIDX) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/project/getWQXProjectMyOrgCount?UserIDX=" + userIDX;
        };
        TWQXProjectApi.getWQXMonLocMyOrgCount = function (userIDX) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/monloc/getWQXMonlocMyOrgCount?UserIDX=" + userIDX;
        };
        TWQXProjectApi.getWqxProject = function (actInd, orgId, wqxPending) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/project/getWqxProject?ActInd=" + actInd + "&OrgID=" + orgId + "&WQXPending=" + wqxPending;
        };
        TWQXProjectApi.getWQXProjectByID = function (projectIdx) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/project/getWQXProjectByID?ProjectIDX=" + projectIdx;
        };
        TWQXProjectApi.InsertOrUpdateWQXProject = function (projectIdx, orgId, projectId, projectName, projectDesc, sampDesignTypeCd, qAppApprovalInd, qAppApprovalAgency, wQxSubmitStatus, wQxSubmitDt, actInd, wqxInd, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/project/InsertOrUpdateWQXProject?pROJECT_IDX=" + projectIdx + "&oRG_ID=" + orgId + "&pROJECT_ID=" + projectId + "&pROJECT_NAME=" + projectName + "&pROJECT_DESC=" + projectDesc + "&sAMP_DESIGN_TYPE_CD=" + sampDesignTypeCd + "&qAPP_APPROVAL_IND=" + qAppApprovalInd + "&qAPP_APPROVAL_AGENCY=" + qAppApprovalAgency + "&wQX_SUBMIT_STATUS=" + wQxSubmitStatus + "&wQX_SUBMIT_DT=" + wQxSubmitDt + "&aCT_IND=" + actInd + "&wQX_IND=" + wqxInd + "&cREATE_USER=" + createUser;
        };
        return TWQXProjectApi;
    }());
    WebApi.TWQXProjectApi = TWQXProjectApi;
    var TWQXActivityApi = /** @class */ (function () {
        function TWQXActivityApi() {
        }
        TWQXActivityApi.getAllActivities = function (ActInd, OrgID, MonLocIDX, startDt, endDt, ActType, WQXPending, ProjectIDX) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getAllActivities?ActInd=" + ActInd + "&OrgID=" + OrgID + "&MonLocIDX=" + MonLocIDX + "&startDt=" + startDt + "&endDt=" + endDt + "&ActType=" + ActType + "&WQXPending=" + WQXPending + "&ProjectIDX=" + ProjectIDX;
        };
        TWQXActivityApi.getTWQXResulTCount = function (OrgID) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getTWQXResulTCount?OrgID=" + OrgID;
        };
        TWQXActivityApi.getWQXActivityMyOrgCount = function (userIDX) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getWQXActivityMyOrgCount?UserIDX=" + userIDX;
        };
        TWQXActivityApi.getWqxActivityDisplay = function (actInd, orgId, monLocIdx, startDt, endDt, actType, wQXPending, projectIdx, wQXStatus) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getWqxActivityDisplay?ActInd=" + actInd + "&OrgID=" + orgId + "&MonLocIDX=" + monLocIdx + "&startDt=" + startDt + "&endDt=" + endDt + "&ActType=" + actType + "&WQXPending=" + wQXPending + "&ProjectIDX=" + projectIdx + "&WQXStatus=" + wQXStatus;
        };
        TWQXActivityApi.deleteTWqxActivity = function (activityIdx, userId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/deleteTWqxActivity?ActivityIDX=" + activityIdx + "&UserID=" + userId;
        };
        TWQXActivityApi.getTWqxRefDataActivityTypeUsed = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getTWqxRefDataActivityTypeUsed?OrgID=" + orgId;
        };
        TWQXActivityApi.getWqxActivityById = function (activityIdx) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getWqxActivityById?ActivityIDX=" + activityIdx;
        };
        TWQXActivityApi.getTWqxResult = function (activityIdx) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/getTWqxResult?ActivityIDX=" + activityIdx;
        };
        return TWQXActivityApi;
    }());
    WebApi.TWQXActivityApi = TWQXActivityApi;
    var TWQXRefDataApi = /** @class */ (function () {
        function TWQXRefDataApi() {
        }
        TWQXRefDataApi.getTWqxRefDefaultTimeZone = function () {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefDefaultTimeZone";
        };
        TWQXRefDataApi.InsertOrUpdateTWQXOrganization = function (orgId, orgName, orgDesc, tribalCode, electronicAddress, electtronicAddressType, telephoneNum, telephoneNumType, telephoneExt, cdxSubmitterId, cdxSubmitterPWD, cdxSubmitterInd, defaultTimeZone, createUser, mailAddress, mailAddCity, mailAddState, mailAddZip) {
        ...
        TWQXRefDataApi.GetTWqxRefCharacteristic = function (actInd, onlyUsedInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefCharacteristic?ActInd=" + actInd + "&onlyUsedInd=" + onlyUsedInd;
        };
        TWQXRefDataApi.GetTWqxRefAnalMethod = function (actInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefAnalMethod?ActInd=" + actInd;
        };
        TWQXRefDataApi.GetTWqxRefData = function (table, actInd, usedInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefData?table=" + table + "&actInd=" + actInd + "&usedInd=" + usedInd;
        };
        TWQXRefDataApi.InsertOrUpdateTWqxRefCharOrg = function (charName, orgName, createUserId, defaultDetectLimit, defaultUnit, defaultAnalMethodIdx, defaultSampFraction, defaultResultStatus, defaultResultTypeValue, defaultLowerQuantLimit, defaultUpperQuantLimit) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/InsertOrUpdateTWqxRefCharOrg?charName=" + charName + "&orgName=" + orgName + "&createUserId=" + createUserId + "&defaultDetectLimit=" + defaultDetectLimit + "&defaultUnit=" + defaultUnit + "&defaultAnalMethodIdx=" + defaultAnalMethodIdx + "&defaultSampFraction=" + defaultSampFraction + "&defaultResultStatus=" + defaultResultStatus + "&defaultResultTypeValue=" + defaultResultTypeValue + "&defaultLowerQuantLimit=" + defaultLowerQuantLimit + "&defaultUpperQuantLimit=" + defaultUpperQuantLimit;
        };
        TWQXRefDataApi.insertOrUpdateTWqxRefTaxaOrg = function (bioSubjectTaxanomy, orgName, createUserId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/insertOrUpdateTWqxRefTaxaOrg?bioSubjectTaxanomy=" + bioSubjectTaxanomy + "&orgName=" + orgName + "&createUserId=" + createUserId;
        };
        TWQXRefDataApi.GetTWqxRefTaxaOrg = function (orgName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefTaxaOrg?orgName=" + orgName;
        };
        TWQXRefDataApi.getAllColumnBasic = function (importType) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getAllColumnBasic?importType=" + importType;
        };
        TWQXRefDataApi.insertOrUpdateWqxImportTranslate = function (translateIdx, orgId, colName, dataFrom, dataTo, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/insertOrUpdateWqxImportTranslate?translateIdx=" + translateIdx + "&orgId=" + orgId + "&colName=" + colName + "&dataFrom=" + dataFrom + "&dataTo=" + dataTo + "&createUser=" + createUser;
        };
        TWQXRefDataApi.GetTWqxRefCharOrg = function (orgName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefCharOrg?orgName=" + orgName;
        };
        TWQXRefDataApi.GetTWqxRefCounty = function (stateCode) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefCounty?stateCode=" + stateCode;
        };
        TWQXRefDataApi.InsertOrUpdateWQXMonLoc = function (monlocIdx, orgId, monlocId, monlocName, monlocType, monlocDesc, hucHeight, hucTwelve, tribalLandInd, tribalLandName, latitudeMsr, longitudeMsr, sourceMapScale, horizAccuracy, horizAccuracyUnit, horizCollMethod, horizRefDatum, vertMeasure, vertMeasureUnit, vertCollMethod, vertRefDatum, countryCode, stateCode, countyCode, wellType, aquiferName, formationType, wellholeDepthMsr, wellholeDepthMsrUnit, wqxSubmitStatus, wqxUpdateDate, actInd, wqxInd, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/monloc/InsertOrUpdateWQXMonLoc?mONLOC_IDX=" + monlocIdx + "&oRG_ID=" + orgId + "&mONLOC_ID=" + monlocId + "&mONLOC_NAME=" + monlocName + "&mONLOC_TYPE=" + monlocType + "&mONLOC_DESC=" + monlocDesc + "&hUC_EIGHT=" + hucHeight + "&HUC_TWELVE=" + hucTwelve + "&tRIBAL_LAND_IND=" + tribalLandInd + "&tRIBAL_LAND_NAME=" + tribalLandName + "&lATITUDE_MSR=" + latitudeMsr + "&lONGITUDE_MSR=" + longitudeMsr + "&sOURCE_MAP_SCALE=" + sourceMapScale + "&hORIZ_ACCURACY=" + horizAccuracy + "&hORIZ_ACCURACY_UNIT=" + horizAccuracyUnit + "&hORIZ_COLL_METHOD=" + horizCollMethod + "&hORIZ_REF_DATUM=" + horizRefDatum + "&vERT_MEASURE=" + vertMeasure + "&vERT_MEASURE_UNIT=" + vertMeasureUnit + "&vERT_COLL_METHOD=" + vertCollMethod + "&vERT_REF_DATUM=" + vertRefDatum + "&cOUNTRY_CODE=" + countryCode + "&sTATE_CODE=" + stateCode + "&cOUNTY_CODE=" + countyCode + "&wELL_TYPE=" + wellType + "&aQUIFER_NAME=" + aquiferName + "&fORMATION_TYPE=" + formationType + "&wELLHOLE_DEPTH_MSR=" + wellholeDepthMsr + "&wELLHOLE_DEPTH_MSR_UNIT=" + wellholeDepthMsrUnit + "&wQX_SUBMIT_STATUS=" + wqxSubmitStatus + "&wQXUpdateDate=" + wqxUpdateDate + "&aCT_IND=" + actInd + "&wQX_IND=" + wqxInd + "&cREATE_USER=" + createUser;
        };
        TWQXRefDataApi.deleteTWqxRefTaxaOrg = function (orgName, charName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/deleteTWqxRefTaxaOrg?orgName=" + orgName + "&charName=" + charName;
        };
        TWQXRefDataApi.deleteTWqxImportTranslate = function (translateId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/deleteTWqxImportTranslate?TranslateID=" + translateId;
        };
        TWQXRefDataApi.deleteWqxRefCharOrg = function (orgName, charName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/deleteWqxRefCharOrg?orgName=" + orgName + "&charName=" + charName;
        };
        TWQXRefDataApi.getTWqxRefDataCount = function () {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefDataCount";
        };
        TWQXRefDataApi.GetTWqxRefCharOrgCount = function (orgName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefDataCount?orgName=" + orgName;
        };
        TWQXRefDataApi.GetTWqxRefSampColMethodByContext = function (context) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/GetTWqxRefSampColMethodByContext?Context=" + context;
        };
        TWQXRefDataApi.insertOrUpdateWqxActivity = function (activityIdx, orgId, projectIdx, monlocIdx, activityId, actType, actMedia, actSubMedia, actStartDate, actEndDt, actTimeZone, relativeDepthName, actDepthHeightMsr, actDepthHeightMsrUnit, topDepthHeightMsr, topDepthHeightMsrUnit, botDepthHeightMsr, botDepthHeightMsrUnit, depthRefPoint, actComment, bioAssemblageSampled, bioDurationMsr, bioDurationMsrUnit, bioSampComponent, bioSampComponentSeq, bioReachLenMsr, bioReachLenMsrUnit, bioReachWidMsr, bioReachWidMsrUnit, bioPassCount, bioNetType, bioNetAreaMsr, bioNetAreaMsrUnit, bioNetMeshsizeMsr, bioMeshsizeMsrUnit, bioBoatSpeedMsr, bioBoatSpeedMsrUnit, bioCurrSpeedMsr, bioCurrSpeedMsrUnit, bioToxicityTestType, sampCollMethodIdx, sampCollEquip, sampCollEquipComment, sampPrepIdx, sampPrepCountType, sampPrepContColor, sampPrepChemPeserv, sampPrepThermPreserv, sampPrepStorageDesc, wqxSubmitStatus, actInd, wqxInd, creatUser, entryType) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/insertOrUpdateWqxActivity?aCTIVITY_IDX=" + activityIdx + "&oRG_ID=" + orgId + "&pROJECT_IDX=" + projectIdx + "&mONLOC_IDX=" + monlocIdx + "&aCTIVITY_ID=" + activityId + "&aCT_TYPE=" + actType + "&aCT_MEDIA=" + actMedia + "&aCT_SUBMEDIA=" + actSubMedia + "&aCT_START_DT=" + actStartDate + "&aCT_END_DT=" + actEndDt + "&aCT_TIME_ZONE=" + actTimeZone + "&rELATIVE_DEPTH_NAME=" + relativeDepthName + "&aCT_DEPTHHEIGHT_MSR=" + actDepthHeightMsr + "&aCT_DEPTHHEIGHT_MSR_UNIT=" + actDepthHeightMsrUnit + "&tOP_DEPTHHEIGHT_MSR" + topDepthHeightMsr + "&tOP_DEPTHHEIGHT_MSR_UNIT=" + topDepthHeightMsrUnit + "&bOT_DEPTHHEIGHT_MSR=" + botDepthHeightMsr + "&bOT_DEPTHHEIGHT_MSR_UNIT=" + botDepthHeightMsrUnit + "&dEPTH_REF_POINT=" + depthRefPoint + "&aCT_COMMENT=" + actComment + "&bIO_ASSEMBLAGE_SAMPLED=" + bioAssemblageSampled + "&bIO_DURATION_MSR=" + bioDurationMsr + "&bIO_DURATION_MSR_UNIT=" + bioDurationMsrUnit + "&bIO_SAMP_COMPONENT=" + bioSampComponent + "&bIO_SAMP_COMPONENT_SEQ=" + bioSampComponentSeq + "&bIO_REACH_LEN_MSR=" + bioReachLenMsr + "&bIO_REACH_LEN_MSR_UNIT=" + bioReachLenMsrUnit + "&bIO_REACH_WID_MSR=" + bioReachWidMsr + "&bIO_REACH_WID_MSR_UNIT=" + bioReachWidMsrUnit + "&bIO_PASS_COUNT=" + bioPassCount + "&bIO_NET_TYPE=" + bioNetType + "&bIO_NET_AREA_MSR=" + bioNetAreaMsr + "&bIO_NET_AREA_MSR_UNIT=" + bioNetAreaMsrUnit + "&bIO_NET_MESHSIZE_MSR=" + bioNetMeshsizeMsr + "&bIO_MESHSIZE_MSR_UNIT=" + bioMeshsizeMsrUnit + "&bIO_BOAT_SPEED_MSR=" + bioBoatSpeedMsr + "&bIO_BOAT_SPEED_MSR_UNIT=" + bioBoatSpeedMsrUnit + "&bIO_CURR_SPEED_MSR=" + bioCurrSpeedMsr + "&bIO_CURR_SPEED_MSR_UNIT=" + bioCurrSpeedMsrUnit + "&bIO_TOXICITY_TEST_TYPE=" + bioToxicityTestType + "&sAMP_COLL_METHOD_IDX=" + sampCollMethodIdx + "&sAMP_COLL_EQUIP=" + sampCollEquip + "&sAMP_COLL_EQUIP_COMMENT=" + sampCollEquipComment + "&sAMP_PREP_IDX=" + sampPrepIdx + "&sAMP_PREP_CONT_TYPE=" + sampPrepCountType + "&sAMP_PREP_CONT_COLOR=" + sampPrepContColor + "&sAMP_PREP_CHEM_PRESERV=" + sampPrepChemPeserv + "&sAMP_PREP_THERM_PRESERV=" + sampPrepThermPreserv + "&sAMP_PREP_STORAGE_DESC=" + sampPrepStorageDesc + "&wQX_SUBMIT_STATUS=" + wqxSubmitStatus + "&aCT_IND=" + actInd + "&wQX_IND=" + wqxInd + "&cREATE_USER=" + creatUser + "&eNTRY_TYPE=" + entryType;
        };
        TWQXRefDataApi.getTWqxRefCharacteristicByOrg = function (orgId, rbpInd) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefCharacteristicByOrg?OrgID=" + orgId + "&RBPInd=" + rbpInd;
        };
        TWQXRefDataApi.insertOrUpdateTWqxResult = function (resultIdx, activityIdx, resultDetectCondition, charName, resultSampFraction, resultMsr, resultMsrUnit, resultStatus, resultValueType, resultComment, bioIntentName, bioIndividualId, bioTaxonomy, bioSampleTissueAnatomy, analyticMethodIdx, labIdx, labanalysisStartDt, detectionLimit, pql, lowerQuantLimit, upperQuantLimit, labSampPrepIdx, labSampPrepStartDt, dilutionFactor, freqClassCode, freqClassUnit, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/insertOrUpdateTWqxResult?rESULT_IDX=" + resultIdx + "&aCTIVITY_IDX=" + activityIdx + "&rESULT_DETECT_CONDITION=" + resultDetectCondition + "&cHAR_NAME=" + charName + "&rESULT_SAMP_FRACTION=" + resultSampFraction + "&rESULT_MSR=" + resultMsr + "&rESULT_MSR_UNIT=" + resultMsrUnit + "&rESULT_STATUS=" + resultStatus + "&rESULT_VALUE_TYPE=" + resultValueType + "&rESULT_COMMENT=" + resultComment + "&bIO_INTENT_NAME=" + bioIntentName + "&bIO_INDIVIDUAL_ID=" + bioIndividualId + "&bIO_TAXONOMY=" + bioTaxonomy + "&bIO_SAMPLE_TISSUE_ANATOMY=" + bioSampleTissueAnatomy + "&aNALYTIC_METHOD_IDX=" + analyticMethodIdx + "&lAB_IDX=" + labIdx + "&lAB_ANALYSIS_START_DT=" + labanalysisStartDt + "&dETECTION_LIMIT=" + detectionLimit + "&pQL=" + pql + "&lOWER_QUANT_LIMIT=" + lowerQuantLimit + "&uPPER_QUANT_LIMIT=" + upperQuantLimit + "&lAB_SAMP_PREP_IDX=" + labSampPrepIdx + "&lAB_SAMP_PREP_START_DT=" + labSampPrepStartDt + "&dILUTION_FACTOR=" + dilutionFactor + "&fREQ_CLASS_CODE=" + freqClassCode + "&fREQ_CLASS_UNIT=" + freqClassUnit + "&cREATE_USER=" + createUser;
        };
        TWQXRefDataApi.getTWqxRefTaxaByOrg = function (orgId) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefTaxaByOrg?OrgID=" + orgId;
        };
        TWQXRefDataApi.getTWqxRefCharLimitsByNameUnit = function (charName, unitName) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/getTWqxRefCharLimitsByNameUnit?CharName=" + charName + "&UnitName=" + unitName;
        };
        TWQXRefDataApi.updateWqxActivityWqxStatus = function (activityIdx, wqxSubmitStatus, actInd, wqxInd, createUser) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/activity/updateWqxActivityWqxStatus?aCTIVITY_IDX=" + activityIdx + "&wQX_SUBMIT_STATUS=" + wqxSubmitStatus + "&aCT_IND=" + actInd + "&wQX_IND=" + wqxInd + "&cREATE_USER=" + createUser;
        };
        TWQXRefDataApi.deleteTWqxResult = function (resultIdx) {
            return _environments_environment__WEBPACK_IMPORTED_MODULE_0__["environment"].api.owUrl + "/api/refdata/deleteTWqxResult?ResultIdx=" + resultIdx;
        };
        return TWQXRefDataApi;
    }());
...
var WqxActivityData = /** @class */ (function () {
    function WqxActivityData() {
    }
    return WqxActivityData;
}());
...
var WqxMonlocData = /** @class */ (function () {
    function WqxMonlocData() {
    }
    return WqxMonlocData;
}());
...
var WqxOrganizationData = /** @class */ (function () {
    function WqxOrganizationData() {
    }
    return WqxOrganizationData;
}());
...
var WqxProjectData = /** @class */ (function () {
    function WqxProjectData() {
    }
    return WqxProjectData;
}());
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _wqx_data_wqx_activity__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../wqx-data/wqx-activity */ "./src/app/@core/wqx-data/wqx-activity.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _utils_web_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/web-api */ "./src/app/@core/utils/web-api.ts");




var WQXActivityService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](WQXActivityService, _super);
    function WQXActivityService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        return _this;
    }
    WQXActivityService.prototype.GetWQX_Activities = function (ActInd, OrgID, MonLocIDX, startDt, endDt, ActType, WQXPending, ProjectIDX) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getAllActivities(ActInd, OrgID, MonLocIDX, startDt, endDt, ActType, WQXPending, ProjectIDX));
    };
    WQXActivityService.prototype.GetT_WQX_RESULTCount = function (OrgID) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getTWQXResulTCount(OrgID));
    };
    WQXActivityService.prototype.getWQXActivityMyOrgCount = function (userIDX) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getWQXActivityMyOrgCount(userIDX));
    };
    WQXActivityService.prototype.getWqxActivityDisplay = function (actInd, orgId, monLocIdx, startDt, endDt, actType, wQXPending, projectIdx, wQXStatus) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getWqxActivityDisplay(actInd, orgId, monLocIdx, startDt, endDt, actType, wQXPending, projectIdx, wQXStatus));
    };
    WQXActivityService.prototype.DeleteT_WQX_ACTIVITY = function (activityIdx, userId) {
        return this.http.delete(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.deleteTWqxActivity(activityIdx, userId));
    };
    WQXActivityService.prototype.InsertOrUpdateWQX_ACTIVITY = function (activityIdx, orgId, projectIdx, monlocIdx, activityId, actType, actMedia, actSubMedia, actStartDate, actEndDt, actTimeZone, relativeDepthName, actDepthHeightMsr, actDepthHeightMsrUnit, topDepthHeightMsr, topDepthHeightMsrUnit, botDepthHeightMsr, botDepthHeightMsrUnit, depthRefPoint, actComment, bioAssemblageSampled, bioDurationMsr, bioDurationMsrUnit, bioSampComponent, bioSampComponentSeq, bioReachLenMsr, bioReachLenMsrUnit, bioReachWidMsr, bioReachWidMsrUnit, bioPassCount, bioNetType, bioNetAreaMsr, bioNetAreaMsrUnit, bioNetMeshsizeMsr, bioMeshsizeMsrUnit, bioBoatSpeedMsr, bioBoatSpeedMsrUnit, bioCurrSpeedMsr, bioCurrSpeedMsrUnit, bioToxicityTestType, sampCollMethodIdx, sampCollEquip, sampCollEquipComment, sampPrepIdx, sampPrepCountType, sampPrepContColor, sampPrepChemPeserv, sampPrepThermPreserv, sampPrepStorageDesc, wqxSubmitStatus, actInd, wqxInd, creatUser, entryType) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXRefDataApi.insertOrUpdateWqxActivity(activityIdx, orgId, projectIdx, monlocIdx, activityId, actType, actMedia, actSubMedia, actStartDate, actEndDt, actTimeZone, relativeDepthName, actDepthHeightMsr, actDepthHeightMsrUnit, topDepthHeightMsr, topDepthHeightMsrUnit, botDepthHeightMsr, botDepthHeightMsrUnit, depthRefPoint, actComment, bioAssemblageSampled, bioDurationMsr, bioDurationMsrUnit, bioSampComponent, bioSampComponentSeq, bioReachLenMsr, bioReachLenMsrUnit, bioReachWidMsr, bioReachWidMsrUnit, bioPassCount, bioNetType, bioNetAreaMsr, bioNetAreaMsrUnit, bioNetMeshsizeMsr, bioMeshsizeMsrUnit, bioBoatSpeedMsr, bioBoatSpeedMsrUnit, bioCurrSpeedMsr, bioCurrSpeedMsrUnit, bioToxicityTestType, sampCollMethodIdx, sampCollEquip, sampCollEquipComment, sampPrepIdx, sampPrepCountType, sampPrepContColor, sampPrepChemPeserv, sampPrepThermPreserv, sampPrepStorageDesc, wqxSubmitStatus, actInd, wqxInd, creatUser, entryType), '', httpOptions);
    };
    WQXActivityService.prototype.GetT_WQX_REF_DATA_ActivityTypeUsed = function (orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getTWqxRefDataActivityTypeUsed(orgId));
    };
    WQXActivityService.prototype.GetWQX_ACTIVITY_ByID = function (activityIdx) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getWqxActivityById(activityIdx));
    };
    WQXActivityService.prototype.GetT_WQX_RESULT = function (activityIdx) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXActivityApi.getTWqxResult(activityIdx));
    };
    WQXActivityService.prototype.UpdateWQX_ACTIVITY_WQXStatus = function (activityIdx, wqxSubmitStatus, actInd, wqxInd, createUser) {
        var httpOptions = {};
        return this.http.put(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXRefDataApi.updateWqxActivityWqxStatus(activityIdx, wqxSubmitStatus, actInd, wqxInd, createUser), '', httpOptions);
    };
    return WQXActivityService;
}(_wqx_data_wqx_activity__WEBPACK_IMPORTED_MODULE_1__["WqxActivityData"]));
...
/* harmony import */ var _wqx_data_wqx_monloc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../wqx-data/wqx-monloc */ "./src/app/@core/wqx-data/wqx-monloc.ts");




var WqxMonlocService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](WqxMonlocService, _super);
    function WqxMonlocService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        return _this;
    }
    WqxMonlocService.prototype.GetWQX_MONLOC = function (ActInd, OrgID, WQXPending) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_2__["WebApi"].TWQXMonlocApi.getWQXMonLoc(ActInd, OrgID, WQXPending));
    };
    WqxMonlocService.prototype.InsertOrUpdateWQX_MONLOC = function (monlocIdx, orgId, monlocId, monlocName, monlocType, monlocDesc, hucHeight, hucTwelve, tribalLandInd, tribalLandName, latitudeMsr, longitudeMsr, sourceMapScale, horizAccuracy, horizAccuracyUnit, horizCollMethod, horizRefDatum, vertMeasure, vertMeasureUnit, vertCollMethod, vertRefDatum, countryCode, stateCode, countyCode, wellType, aquiferName, formationType, wellholeDepthMsr, wellholeDepthMsrUnit, wqxSubmitStatus, wqxUpdateDate, actInd, wqxInd, createUser) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_2__["WebApi"].TWQXRefDataApi.InsertOrUpdateWQXMonLoc(monlocIdx, orgId, monlocId, monlocName, monlocType, monlocDesc, hucHeight, hucTwelve, tribalLandInd, tribalLandName, latitudeMsr, longitudeMsr, sourceMapScale, horizAccuracy, horizAccuracyUnit, horizCollMethod, horizRefDatum, vertMeasure, vertMeasureUnit, vertCollMethod, vertRefDatum, countryCode, stateCode, countyCode, wellType, aquiferName, formationType, wellholeDepthMsr, wellholeDepthMsrUnit, wqxSubmitStatus, wqxUpdateDate, actInd, wqxInd, createUser), '', httpOptions);
    };
    WqxMonlocService.prototype.GetWQX_MONLOC_ByID = function (monlocIdx) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_2__["WebApi"].TWQXMonlocApi.GetWQXMonLocByID(monlocIdx));
    };
    WqxMonlocService.prototype.GetWQX_MONLOC_ByOrgID = function (orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_2__["WebApi"].TWQXMonlocApi.getWqxMonlocByOrgId(orgId));
    };
    return WqxMonlocService;
}(_wqx_data_wqx_monloc__WEBPACK_IMPORTED_MODULE_3__["WqxMonlocData"]));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _wqx_data_wqx_organization__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../wqx-data/wqx-organization */ "./src/app/@core/wqx-data/wqx-organization.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _utils_web_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/web-api */ "./src/app/@core/utils/web-api.ts");
...
var WQXOrganizationService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](WQXOrganizationService, _super);
    function WQXOrganizationService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        return _this;
    }
    WQXOrganizationService.prototype.ConnectTestResult = function (orgId, typ) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.connectTest(orgId, typ));
    };
    WQXOrganizationService.prototype.GetWQX_USER_ORGS_ByUserIDX = function (userIDX, excludePendingInd) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getUserOrgsByUserIDX(userIDX, excludePendingInd));
    };
    WQXOrganizationService.prototype.GetWQX_USER_ORGS_AdminsByOrg = function (OrgID) {
    };
    WQXOrganizationService.prototype.GetWQX_ORGANIZATION_ByID = function (orgID) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.GetWQXOrganizationById(orgID));
    };
    WQXOrganizationService.prototype.ApproveRejectTWqxUserOrgs = function (orgID, userIDX, ApproveRejectCode) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.approveRejectTWqxUserOrgs(orgID, userIDX, ApproveRejectCode), '', httpOptions);
    };
    WQXOrganizationService.prototype.getVWQXAllOrgs = function () {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getVWQXAllOrgs());
    };
    WQXOrganizationService.prototype.getAdminTaskData = function (userName, OrgID) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getAdminTaskData(userName, OrgID));
    };
    WQXOrganizationService.prototype.getWQXOrganizationById = function (orgID) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.GetWQXOrganizationById(orgID));
    };
    WQXOrganizationService.prototype.getTEPAOrgsByOrgId = function (userIDX) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getTEPAOrgByOrgId(userIDX));
    };
    WQXOrganizationService.prototype.InsertOrUpdateTWQXOrganization = function (oRG_ID, oRG_NAME, oRG_DESC, tRIBAL_CODE, eLECTRONIC_ADDRESS, eLECTRONICADDRESSTYPE, tELEPHONE_NUM, tELEPHONE_NUM_TYPE, TELEPHONE_EXT, cDX_SUBMITTER_ID, cDX_SUBMITTER_PWD, cDX_SUBMIT_IND, dEFAULT_TIMEZONE, cREATE_USER, mAIL_ADDRESS, mAIL_ADD_CITY, mAIL_ADD_STATE, mAIL_ADD_ZIP) {
        var httpOptions = {};
    ...
    WQXOrganizationService.prototype.getWQXUserOrgsAdminsByOrg = function (orgID) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.GetWQXUserOrgsAdminsByOrg(orgID));
    };
    WQXOrganizationService.prototype.insertTWQXUserOrgs = function (orgID, userIDX, roleCD, createUser) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.insertTWQXUserOrgs(orgID, userIDX, roleCD, createUser), '', httpOptions);
    };
    WQXOrganizationService.prototype.GetT_WQX_REF_DATA = function (table, actInd, usedInd) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getTWqxRefData(table, actInd, usedInd));
    };
    WQXOrganizationService.prototype.GetT_OE_USERSInOrganization = function (orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getTOeUsersInOrganization(orgId));
    };
    WQXOrganizationService.prototype.GetT_OE_USERSNotInOrganization = function (orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.getTOeUsersNotInOrganization(orgId));
    };
    WQXOrganizationService.prototype.deleteTWqxUserOrgs = function (orgId, userIdx) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.deleteTWqxUserOrgs(orgId, userIdx), '', httpOptions);
    };
    WQXOrganizationService.prototype.GetWQX_IMPORT_TRANSLATE_byOrg = function (orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.GetWqxImportTranslatebyOrg(orgId));
    };
    WQXOrganizationService.prototype.CanUserEditOrg = function (userIdx, orgId) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXOrganizationApi.canUserEditOrg(userIdx, orgId));
    };
    return WQXOrganizationService;
}(_wqx_data_wqx_organization__WEBPACK_IMPORTED_MODULE_1__["WqxOrganizationData"]));
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _wqx_data_wqx_project__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../wqx-data/wqx-project */ "./src/app/@core/wqx-data/wqx-project.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _utils_web_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/web-api */ "./src/app/@core/utils/web-api.ts");
...
var WQXProjectService = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](WQXProjectService, _super);
    function WQXProjectService(http) {
        var _this = _super.call(this) || this;
        _this.http = http;
        return _this;
    }
    WQXProjectService.prototype.GetWQX_PROJECTS = function () {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.getAllProjects());
    };
    WQXProjectService.prototype.GetWQXProjectMyOrgCount = function (userIDX) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.getWQXProjectMyOrgCount(userIDX));
    };
    WQXProjectService.prototype.GetWQXMonlocMyOrgCount = function (userIDX) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.getWQXMonLocMyOrgCount(userIDX));
    };
    WQXProjectService.prototype.GetWQX_PROJECT = function (actInd, orgId, wqxPending) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.getWqxProject(actInd, orgId, wqxPending));
    };
    WQXProjectService.prototype.GetWQX_PROJECT_ByID = function (projectIdx) {
        return this.http.get(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.getWQXProjectByID(projectIdx));
    };
    WQXProjectService.prototype.InsertOrUpdateWQX_PROJECT = function (projectIdx, orgId, projectId, projectName, projectDesc, sampDesignTypeCd, qAppApprovalInd, qAppApprovalAgency, wQxSubmitStatus, wQxSubmitDt, actInd, wqxInd, createUser) {
        var httpOptions = {};
        return this.http.post(_utils_web_api__WEBPACK_IMPORTED_MODULE_3__["WebApi"].TWQXProjectApi.InsertOrUpdateWQXProject(projectIdx, orgId, projectId, projectName, projectDesc, sampDesignTypeCd, qAppApprovalInd, qAppApprovalAgency, wQxSubmitStatus, wQxSubmitDt, actInd, wqxInd, createUser), '', httpOptions);
    };
    return WQXProjectService;
}(_wqx_data_wqx_project__WEBPACK_IMPORTED_MODULE_1__["WqxProjectData"]));
...
var WqxPubsubServiceService = /** @class */ (function () {
    function WqxPubsubServiceService() {
    ...
    WqxPubsubServiceService.prototype.setData = function (data) {
        this.loadData.next(data);
    };
    WqxPubsubServiceService.prototype.fieldChanged = function (data) {
        this.fieldData.next(data);
    };
    WqxPubsubServiceService.prototype.charChanged = function (data) {
        this.fieldData.next(data);
    };
    WqxPubsubServiceService.prototype.setMonLocData = function (data) {
        this.monlocChkData.next(data);
    };
    WqxPubsubServiceService.prototype.setProjectData = function (data) {
        this.projectChkData.next(data);
    };
    WqxPubsubServiceService.prototype.setActivityData = function (data) {
    ...
    return WqxPubsubServiceService;
}());
...
/* harmony import */ var _nebular_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nebular/auth */ "./node_modules/@nebular/auth/fesm5/index.js");
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        if (this.user.UserIDX !== null) {
            this.organizationService.GetWQX_USER_ORGS_ByUserIDX(+this.user.UserIDX, true).subscribe(function (data) {
                data.forEach(function (element) {
                    var newOrg = {};
                    newOrg.orgId = element.orgId;
                    newOrg.orgFormalName = element.orgFormalName;
                    _this.orgs.push(newOrg);
                });
            }, function (err) {
                console.log(err);
            });
    ...
    HeaderComponent.prototype.changeOrg = function (orgName) {
        console.log(orgName);
...
var ContentTypeInterceptor = /** @class */ (function () {
    ...
    ContentTypeInterceptor.prototype.intercept = function (req, next) {
        var ct = req.detectContentTypeHeader();
        if (ct != null) {
...
var NgxAuthJWTInterceptor = /** @class */ (function () {
    function NgxAuthJWTInterceptor(injector, filter) {
        this.injector = injector;
        this.filter = filter;
    }
    NgxAuthJWTInterceptor.prototype.intercept = function (req, next) {
        var _this = this;
    ...
    Object.defineProperty(NgxAuthJWTInterceptor.prototype, "authService", {
        get: function () {
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _nebular_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nebular/auth */ "./node_modules/@nebular/auth/fesm5/index.js");
...
/* harmony import */ var _nebular_auth__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @nebular/auth */ "./node_modules/@nebular/auth/fesm5/index.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _nebular_theme__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @nebular/theme */ "./node_modules/@nebular/theme/fesm5/index.js");
...
/* harmony import */ var _nebular_security__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! @nebular/security */ "./node_modules/@nebular/security/fesm5/index.js");
...
/* harmony import */ var _nebular_eva_icons__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! @nebular/eva-icons */ "./node_modules/@nebular/eva-icons/fesm5/index.js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ɵ0", function() { return ɵ0; });
var ɵ0 = function (req) { return false; };
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.authService.isAuthenticated()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (authenticated) {
            if (!authenticated) {
